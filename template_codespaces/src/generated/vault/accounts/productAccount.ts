...
/** Gets the encoder for {@link ProductAccountArgs} account data. */
...
/** Gets the decoder for {@link ProductAccount} account data. */
export function getProductAccountDecoder(): Decoder<ProductAccount> {
  return getStructDecoder([
    ...
    ["totalRedeemed", getU32Decoder()],
    ["createdAt", getI64Decoder()],
    ["bump", getU8Decoder()],
  ]);
}

/** Gets the codec for {@link ProductAccount} account data. */
